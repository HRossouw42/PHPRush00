...
if (isset($_POST['insert_post']))
{
	...
	$insert_product = "insert into products (product_cat, product_title, product_price, product_brand, product_desc, product_image, product_keywords) values ('$product_cat','$product_title', '$product_price', '$product_brand', '$product_desc', '$product_image', '$product_keywords')";
