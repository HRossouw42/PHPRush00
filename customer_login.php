...
<link rel="stylesheet" href="styles/style.css" media="all" />
	<form method="post" action=""> 
		...
		<table width="500" align="center" bgcolor="lightgrey"> 
			...
			<h2 style="float:right; padding-right:20px; color:whitesmoke"><a href="customer_register.php" style="text-decoration:none;">Just started adventuring? Create an account here!</a></h2>
